...
public final class Constants {
    ...
    public static final class BalanceConstants {
        ...
        public static final double kBalancingControlTresholdDegrees = 3;
        public static final double kBalancingControlDriveKP = 0.025; // P (Proportional) constant of a PID loop
        public static final double kBalancingControlBackwardsPowerMultiplier = 10;
    }
